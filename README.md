...
- [Be familiar with a breadth of new techniques](#be-familiar-with-a-breadth-of-new-techniques)
...
- [Be able to develop REST APIs](#be-able-to-develop-rest-apis)
- [Be able to build interactive webapps for models](#be-able-to-build-interactive-webapps-for-models)
