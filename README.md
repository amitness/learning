...
- [X] [MIT: 18.06 Linear Algebra (Professor Strang): Lec 1-5](https://ocw.mit.edu/courses/mathematics/18-06-linear-algebra-spring-2010/)
...
- [ ] [Book: Natural Language Processing with TensorFlow](https://www.packtpub.com/application-development/natural-language-processing-tensorflow)
...
- [X] [Datacamp: Spoken Language Processing in Python](https://www.datacamp.com/courses/spoken-language-processing-in-python)
