...
- [Be familiar with how ML is applied at other companies](#be-familiar-with-how-ml-is-applied-at-other-companies)
...
- [Be able to use Linux](#be-able-to-use-linux)
- [Be able to perform feature selection and engineering](#be-able-to-perform-feature-selection-and-engineering)
...
- [Be able to setup project structure](#be-able-to-setup-project-structure)
...
- [Be able to use experiment management tools](#be-able-to-use-experiment-management-tools)
- [Be able to setup model validation](#be-able-to-setup-model-validation)
- [Be familiar with inner working of models](#be-familiar-with-inner-working-of-models)
- [Be able to improve model generalization](#be-able-to-improve-model-generalization)
- [Be familiar with fundamental ML concepts](#be-familiar-with-fundamental-ml-concepts)
...
- [Be able to perform hyperparameter tuning](#be-able-to-perform-hyperparameter-tuning)
...
- [Be familiar with ML System Design](#be-familiar-with-ml-system-design)
- [Be able to serve ML models](#be-able-to-serve-ml-models)
- [Be able to setup batch inference](#be-able-to-setup-batch-inference)
- [Be able to build interactive UI for models](#be-able-to-build-interactive-ui-for-models)
- [Be able to use Docker for containerization](#be-able-to-use-docker-for-containerization)
- [Be able to use Cloud](#be-able-to-use-cloud)
- [Be familiar with serverless architecture](#be-familiar-with-serverless-architecture)
- [Be able to monitor ML models](#be-able-to-monitor-ml-models)
...
- [ ] [Youtube: Yangqing Jia on Deep Learning Frameworks (Full Stack Deep Learning - August 2018)](https://youtu.be/s2MWUamDYUI?list=PL1T8fO7ArWlf4EkqeguoD70LsnOJ7c9Ib)
...
- [ ] [Youtube: MLOps #19 // DataOps and Data versioning in ML](https://www.youtube.com/watch?v=ojV1tK9jXH8) `1:01:55`
...
- [ ] [Youtube: Applied ML 2020 - 01 Introduction](https://www.youtube.com/watch?v=rbvpiPJuK64) `1:16:01`
